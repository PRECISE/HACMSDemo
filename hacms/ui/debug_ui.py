...
#
# Created: Thu Jul 18 14:46:27 2013
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.sensorAttackComboBox.setGeometry(QtCore.QRect(20, 420, 131, 31))
        font = QtGui.QFont()
        ...
        self.attackComboBox.setGeometry(QtCore.QRect(20, 470, 131, 31))
        font = QtGui.QFont()
        font.setPointSize(16)
        ...
        self.trimPlot = QtGui.QWidget(self.debug_tab)
        self.trimPlot.setEnabled(False)
        self.trimPlot.setGeometry(QtCore.QRect(10, 30, 331, 201))
        self.trimPlot.setStyleSheet(_fromUtf8("background-color: white;"))
        self.trimPlot.setObjectName(_fromUtf8("trimPlot"))
        self.trimPlotLabel = QtGui.QLabel(self.debug_tab)
        self.trimPlotLabel.setEnabled(False)
        self.trimPlotLabel.setGeometry(QtCore.QRect(10, 10, 91, 16))
...
"Controller", None))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.debug_tab), _translate("MainWindow", "DEBUG", None))
