...
#
# Created: Mon Aug  5 16:33:24 2013
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(431, 194)
        self.aboutText = QtGui.QLabel(Dialog)
        self.aboutText.setGeometry(QtCore.QRect(0, 100, 431, 91))
        ...
        self.pennLogo.setGeometry(QtCore.QRect(-1, 2, 431, 101))
