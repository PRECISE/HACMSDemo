...
#
# Created: Tue Jul  2 15:06:52 2013
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(930, 586)
        MainWindow.setUnifiedTitleAndToolBarOnMac(True)
        self.centralWidget = QtGui.QWidget(MainWindow)
        self.centralWidget.setObjectName("centralWidget")
        self.landsharkButton = QtGui.QPushButton(self.centralWidget)
        self.landsharkButton.setGeometry(QtCore.QRect(10, 10, 201, 71))
        ...
        self.rcButton.setGeometry(QtCore.QRect(220, 10, 241, 71))
        ...
        self.attackButton.setGeometry(QtCore.QRect(220, 90, 241, 71))
        ...
        self.actualSpeedLCD.setGeometry(QtCore.QRect(20, 210, 171, 71))
        self.actualSpeedLCD.setObjectName("actualSpeedLCD")
        self.expectedLabel = QtGui.QLabel(self.centralWidget)
        self.expectedLabel.setGeometry(QtCore.QRect(230, 180, 221, 51))
        font = QtGui.QFont()
        ...
        self.actualLabel.setGeometry(QtCore.QRect(230, 240, 221, 51))
        font = QtGui.QFont()
        font.setPointSize(36)
